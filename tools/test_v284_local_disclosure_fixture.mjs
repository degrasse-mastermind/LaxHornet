...
for (const [name, overrides, pattern] of [
  ...
  ["rejects usable old access token after deletion", { oldAuthTokenRejectedAfterDelete: false }, /after user deletion/],
  ...
  ["rejects private RPC probe after game deletion", { privateRpcProbeGameRows: 0 }, /retained synthetic game/],
  ["rejects unavailable session inspection", { sessionsRemaining: undefined }, /session remained/],
  ["rejects null session inspection", { sessionsRemaining: null }, /session remained/],
  ["rejects blank refresh-token inspection", { refreshTokensRemaining: "" }, /refresh token remained/],
  ["rejects null user inspection", { usersRemaining: null }, /user remained/],
