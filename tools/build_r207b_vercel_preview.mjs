...
assert.ok(runtime.includes("r207AtomicScoredEvents: false"), "default-off LH-25 atomic scored-event flag is missing");
const previewRuntime = connectedPreview
  ? runtime
    ...
    .replace("r207AtomicScoredEvents: false", "r207AtomicScoredEvents: true")
    .replace(
