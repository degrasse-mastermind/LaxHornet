# R2-07E V2 Exact-SHA Baseline Manifest

Status: `BOUND BEFORE CERTIFICATION EXECUTION`

- Certification baseline: `b7269194a4ce8b9068b0d46c44d840efc4048c69`
- Baseline tree: `f2f0a34f448481ec8856e346d415e1a1e7bde354`
- Reviewed clock-remediation head: `785654132ead3fe20e0c54820f13747ee4a190a4`
- Reviewed-head/merge tree identity: `EXACT MATCH`
- Historical failed certification: PR #70 at `6cbcad274961aff8e8f701c63d26bec58193d93c`
- Branch: `feature/r2-07e-integrated-certification-v2`
- Release marker: `v285`
- Service-worker cache marker: `laxhornet-v285`
- Runtime capabilities: R2-07B `false`; R2-07C `false`; R2-07D `false`; clock command/batch `false`
- Production-write activation: `DORMANT`

Historical `BASELINE_MANIFEST.md` and `R2-07E_CERTIFICATION_REPORT.md` remain
the truthful failed-certification record and are not current evidence. This
fresh certification is bound only to the merged baseline above.

All hashes below are SHA-256 over exact Git blob bytes from
`b7269194a4ce8b9068b0d46c44d840efc4048c69`. They are not hashes of the
Windows working-tree representation.
...
| `supabase/migrations/20260811010813_r207_clock_command_batch_integration.sql` | `c09cbb8988418d24c42c3882f21a465fd4365561c14cada64a3bd4dc20998409` |
...
| `supabase/rollback/20260811010813_r207_clock_command_batch_integration_rollback.sql` | `8548bbe4e91f506a2222bfe7feab826d4e5725dcfe98ac98098075b3484e1c93` |
...
## Environment boundary before mutation testing

Certification uses only disposable PostgreSQL 17 containers, synthetic adult
identities and records, and isolated local browser contexts. Test tooling is
