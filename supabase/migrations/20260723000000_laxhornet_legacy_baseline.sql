-- LaxHornet canonical legacy schema baseline
-- Reconstructs the schema required by Trust Spine on a blank Supabase preview.
-- Schema only: no production rows, user identities, credentials, or data cleanup.
